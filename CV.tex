...
\begin{tikzpicture}[remember picture, overlay] 
  ...
  \end{tikzpicture}%
\centerline{\LARGE\bfseries{邹洛斌}} 

\centerline{\normalsize{\faPhone\ 135-0674-6671 \quad \faEnvelopeO\ \href{mailto:3230104074@zju.edu.cn}{3230104074@zju.edu.cn}}} 
...
微电子科学与工程\quad 大三 
\begin{itemize}[nosep]
    \item 相关课程：《模拟集成电路设计》、《微电子器件》、《数字系统设计》
\end{itemize}
